...
namespace Ponca {
    ...
    // [PointPositionNormalLateBinding]
     ...
     */
    template<typename _Scalar, int _Dim>
    class PointPositionNormalLateBinding
    {
    public:
        enum {Dim = _Dim};
        typedef _Scalar Scalar;
        ...
        PONCA_MULTIARCH inline PointPositionNormalLateBinding(Scalar* _interlacedArray, const int _pId)
